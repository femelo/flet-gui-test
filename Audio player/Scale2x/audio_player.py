...
class AudioPlayer(ft.Container):
    def __init__(
        ...
        scale: float = 1.0,  # Voeg een schaalparameter toe
        *args,
        **kwargs,
    ):
        ...
        self.scale = ft.Scale(scale, scale)  # Instellen van de schaal
    ...
    def play_pause(self, e):
        ...
        try:
            ...
            self.is_request_pending = False  # Zorg ervoor dat de vlag altijd wordt gereset
